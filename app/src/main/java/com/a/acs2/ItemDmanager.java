...
public class ItemDmanager {

    String name;
    String email;
    String imgnum, id, lectitle;
    int image;
    int pause;
    int dlt;
    int done;
    ...
    public ItemDmanager(String name, String email, float percent, int image, int pause, int dlt, boolean hidden, String imgnum, String id, String lectitle) {
        this.name = name;
        this.email = email;
        this.imgnum = imgnum;
        this.image = image;
